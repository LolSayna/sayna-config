...
# Cli word lookup script
# inspiration: https://youtu.be/pF7BCKWd1eM?si=-XtsJyT2TdMVu64E
    # Tasks: DE-EN/EN-DE translation of words and sentences
    # definiton of words/example usecase
    # Synonyms finder

# APIs online:
    # https://github.com/meetDeveloper/freeDictionaryAPI
    # curl dict://dict.org/d:testing
# Offline
    # wordnet - `sudo apt install wordnet`
    # dictd - `sudo apt install dict`, needs downloaded dicts

# xclip for X, wl-paste for wayland
